...
class ReceiptDTO {
    ...
    constructor({id, controllerUid, email, sno, inn, place, itemName, itemPrice, paymentType, fiscalData, status, createdAt, kktRegNumber, itemType, rekassa_password, rekassa_number, rekassa_kkt_id, kktProvider}) {
        this.id = id
